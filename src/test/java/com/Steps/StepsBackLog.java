...
public class StepsBackLog {
	...
	public void clickOnBookmarkIconAndBookmarkQuestionAndGoBack() {
		takequizTestPage.bookmaringQues();
	}

	@QAFTestStep(description = "user Navigate to Your Collections screen")
	public void navigateToYourCollectionsScreen() {
	...
	public void userSearchForInfoStretch() {
