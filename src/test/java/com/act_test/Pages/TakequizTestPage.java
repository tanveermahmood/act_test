...
public class TakequizTestPage extends WebDriverBaseTestPage<WebDriverTestPage> {
	...
	@FindBy(locator = "Takequiz.note.title")
	private QAFWebElement verifyNoteTitle;
	@FindBy(locator = "Takequiz.whiteboard.title")
	private QAFWebElement verifyWhiteboardTitle;
	@FindBy(locator = "Takequiz.web.title")
	...
	public void VerifyBookmarkedQues(String BookmarkQues)
	{
